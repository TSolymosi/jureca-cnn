...
JOB_ID="13686127" # Replace with the actual JOB ID of the sleeping job
...
ORIGINAL_FILE_LIST_PATH="/p/scratch/pasta/CNN/17.03.25/SpectralSpatial3DCNN/FileList/file_list.txt"
...
" | tee slurm_output/all_files/${JOB_ID}.log
