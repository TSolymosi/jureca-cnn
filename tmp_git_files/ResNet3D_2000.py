...
class SpectralSpatialResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.spectral_conv = nn.Sequential(
            spectral_conv1d(1, 16, kernel_size=11, stride=5),
            nn.BatchNorm3d(16),
            nn.ReLU(inplace=True),
            spectral_conv1d(16, 32, kernel_size=11, stride=5),
            nn.BatchNorm3d(32),
            nn.ReLU(inplace=True),
            spectral_conv1d(32, block_inplanes[0], kernel_size=5, stride=5),
...
if __name__ == "__main__":
    ...
    os.makedirs(f"ResNetPlots/2000_files", exist_ok=True)
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 10 == 0:
            os.makedirs(f"ResNetPlots/2000_files/Epochs", exist_ok=True)
            ...
            for i, param in enumerate(labels):
                ...
                plt.legend()
                plt.tight_layout()
                plt.savefig(f"ResNetPlots/2000_files/Epochs/epoch_{epoch+1}_{param}_2000.png")
                plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("ResNetPlots/2000_files/Train_vs_Validation_2000.png")
    print("Saved: Train_vs_Validation_2000.png")
    ...
    #plt.grid(True)
    #plt.tight_layout()
    #plt.savefig("ResNetPlots/2000_files/per_parameter_mae_100.png")
    ...
    for param in args.model_params:
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f"ResNetPlots/2000_files/{param}_loss_2000.png")
        print(f"Saved: {param}_loss_2000.png")